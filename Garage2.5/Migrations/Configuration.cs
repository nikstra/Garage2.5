    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Garage2.Models.VehiclesDb>
    {
        ...
        protected override void Seed(Garage2.Models.VehiclesDb context)
        {
            ...
            context.vehicles.AddOrUpdate(
                ...
                new vehicle { RegNumber = "BCD 456", Colour = "blå", VehicleTypeId = 1, MemberId = 1, Model = "Saab", Wheels = 4, ParkedTime = new DateTime(2016, 1, 24, 10, 12, 0), VehicleType = new VehicleType { Type = "Bil" } },
                new vehicle { RegNumber = "CDE 789", Colour = "gul", VehicleTypeId = 1, MemberId = 1, Model = "Opel", Wheels = 4, ParkedTime = new DateTime(2016, 1, 29, 8, 56, 0), VehicleType = new VehicleType { Type = "Bil" } }
                );
        }
    }
}
