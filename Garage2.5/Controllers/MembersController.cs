...
namespace Garage2.Controllers
{
    public class MembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MemberId,Name,email,mobile")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberId,Name,email,mobile")] Member member)
        {
            if (ModelState.IsValid)
            {
